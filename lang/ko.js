...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {적용된 필터 없음.} one {{number}개 필터 적용됨.} other {{number}개 필터 적용됨.}}",
	"components.filter.filters": "개 필터",
	"components.filter.noActiveFilters": "활성 필터가 없음",
	"components.filter.noFilters": "사용 가능한 필터가 없습니다",
	"components.filter.searchResults": "{number, plural, =0 {검색 결과 없음} one {{number}개 검색 결과} other {{number}개 검색 결과}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {제출한 정보에서 {count}개의 오류가 발견되었습니다} other {제출한 정보에서 {count}개의 오류가 발견되었습니다}}",
