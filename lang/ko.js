export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "항목 재정렬, 현재 위치 {currentPosition}, 크기 {size}. 이 항목을 이동하려면 위쪽 또는 아래쪽 화살표를 누르세요.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "목록에서 항목을 좌우로 이동합니다.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "목록에서 항목을 좌우로 이동합니다.",
	...
	"components.page.footer-region-label": "바닥글",
	...
	"components.skip-nav.skipToMainContent": "메인 콘텐츠로 건너뛰기",
