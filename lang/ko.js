...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {적용된 필터 없음.} one {1개 필터 적용됨.} other {{number}개 필터 적용됨.}}",
	"components.filter.filters": "개 필터",
	"components.filter.noFilters": "사용 가능한 필터가 없습니다",
	"components.filter.searchResults": "{number, plural, =0 {검색 결과 없음} one {1개 검색 결과} other {{number}개 검색 결과}}",
