...
export default {
	...
	"components.form-element.input.number.rangeError": "숫자는 {min}에서 {max} 사이여야 합니다.",
	"components.form-element.input.number.rangeOverflow": "숫자는 {max}보다 작아야 합니다",
	"components.form-element.input.number.rangeUnderflow": "숫자는 {min}보다 커야 합니다",
	...
	"components.form-error-summary.errorSummary": "제출한 정보에서 {count, plural, one {1개의 오류} other {were{count}개의 오류}}가 발견되었습니다",
