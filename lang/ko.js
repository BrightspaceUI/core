export default {
	...
	"components.pageable.info": "{count, plural, one {해당 항목 수 {countFormatted}개} other {해당 항목 수 {countFormatted}개}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{totalCountFormatted}개 항목 중 {showingCount}개} other {{totalCountFormatted}개 항목 중 {showingCount}개}",
