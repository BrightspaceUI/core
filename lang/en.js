export default {
	...
	"components.input-date-time.errorMaxDateOnly": "Date must be {maxDate} or before",
	"components.input-date-time.errorMinDateOnly": "Date must be {minDate} or later",
	...
	"components.input-date.errorMaxDateOnly": "Date must be {maxDate} or before",
	"components.input-date.errorMinDateOnly": "Date must be {minDate} or later",
