...
export default {
	...
	"components.form-element.input.number.rangeError": "Number must be higher than{minInclusive} {min} and lower than{maxInclusive} {max}.",
	"components.form-element.input.number.rangeOverflow": "Number must be lower than{maxInclusive} {max}.",
	"components.form-element.input.number.rangeUnderflow": "Number must be higher than{minInclusive} {min}.",
