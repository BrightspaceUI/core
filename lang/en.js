export default {
	...
	"components.filter-dimension-set-date-time-range-value.descriptiveTextRange": "{startValue} to {endValue}",
	"components.filter-dimension-set-date-time-range-value.descriptiveTextRangeStartOnly": "Start: {startValue}",
	"components.filter-dimension-set-date-time-range-value.descriptiveTextRangeEndOnly": "End: {endValue}",
