export default {
	...
	"components.list-item-drag-handle-tooltip.side-to-side.enter-desc": "Toggle keyboard reorder mode.",
	"components.list-item-drag-handle-tooltip.side-to-side.enter-key": "Enter",
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Move item left or right in the list.",
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-key": "Left/Right",
	"components.list-item-drag-handle-tooltip.side-to-side.title": "Keyboard Controls for Reordering:",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Move item left or right in the list.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-key": "Up/Down",
