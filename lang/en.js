...
export default {
	...
	"components.input-number.errorMaxNumberOnly": "{label} must be lower than {maxNumber}.",
	"components.input-number.errorMinNumberOnly": "{label} must be higher than {minNumber}.",
	"components.input-number.errorOutsideRange": "{label} must be between {minNumber} and {maxNumber}.",
