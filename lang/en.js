...
export default {
	...
	"components.list-item-tooltip.up-down": "Focus list items with the Up & Down Arrows.",
	"components.list-item-tooltip.left-right": "Focus options within each item with the Left & Right Arrows.",
	"components.list-item-tooltip.enter": "Activate the focused option with Enter.",
	"components.list-item-tooltip.page-up-down": "Jump five items at a time with Page Up & Page Down.",
	"components.list-item-drag-handle-tooltip.title": "Keyboard Controls for Reordering:",
	"components.list-item-drag-handle-tooltip.enter": "Use Enter to toggle keyboard reorder mode and:",
	"components.list-item-drag-handle-tooltip.up-down": "Move this item with the Up & Down Arrows.",
	"components.list-item-drag-handle-tooltip.left-right": "Change nesting level with the Left & Right Arrows.",
