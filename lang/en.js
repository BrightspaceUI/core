export default {
	...
	"components.filter-dimension-set-date-text-value.text": "{type, select, today {Today} lastHour {Last Hour} hours {{num} Hours} days {{num} Days} months {{num} Months} other {Other}}",
