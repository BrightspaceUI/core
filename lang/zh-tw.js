export default {
	...
	"components.pageable.info": "{count, plural, one {{countFormatted} 個項目} other {{countFormatted} 個項目}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{countFormatted} 項，共 {totalCountFormatted} 項} other {{countFormatted} 項，共 {totalCountFormatted} 項}}",
