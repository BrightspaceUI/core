export default {
	...
	"components.filter-dimension-set-date-text-value.textHours": "{num, plural, one {過去一小時} other {過去 {num} 小時}}",
	"components.filter-dimension-set-date-text-value.textDays": "{num, plural, =0 {今天} one {過去 {num} 天} other {過去 {num} 天}}",
