...
export default {
	...
	"components.form-element-mixin.defaultFieldLabel": "欄位",
	"components.form-element-mixin.defaultValidationMessage": "{label} 無效。",
	"components.form-element-mixin.valueMissingMessage": "{label} 為必填。",
