...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {未套用篩選器。} one {已套用 {number} 個篩選器。} other {已套用 {number} 個篩選器。}}",
	"components.filter.filters": "篩選器",
	"components.filter.noActiveFilters": "沒有啟用中的篩選器",
	"components.filter.noFilters": "沒有可用的篩選條件",
	"components.filter.searchResults": "{number, plural, =0 {無搜尋結果} one {{number} 個搜尋結果} other {{number} 個搜尋結果}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {您提交的資訊中發現 {count} 個錯誤} other {您提交的資訊中發現 {count} 個錯誤}}",
