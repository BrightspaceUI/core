...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {未套用篩選條件。} one {已套用 1 項篩選條件。} other {已套用 {number} 項篩選條件。}}",
	"components.filter.filters": "篩選器",
	"components.filter.noFilters": "沒有可用的篩選條件",
	"components.filter.searchResults": "{number, plural, =0 {無搜尋結果} one {1 個搜尋結果} other {{number} 個搜尋結果}}",
