export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Réorganiser l’élément, position actuelle {currentPosition} de {size}. Pour déplacer cet élément, utilisez les flèches vers la gauche et vers la droite.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Déplacer l’élément vers la gauche ou vers la droite dans la liste.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Déplacer l’élément vers la gauche ou vers la droite dans la liste.",
	...
	"components.page.footer-region-label": "Pied de page",
	...
	"components.page.supporting-scrim": "Le contenu principal est actuellement masqué par le panneau de support. Fermez le panneau pour y accéder.",
