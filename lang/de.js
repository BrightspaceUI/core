export default {
	...
	"components.table.a-to-z": "Sorted A to Z",
	"components.table.z-to-a": "Sorted Z to A",
	"components.table.low-to-high": "Sorted low to high",
	"components.table.high-to-low": "Sorted high to low",
	"components.table.old-to-new": "Sorted old to new",
	"components.table.new-to-old": "Sorted new to old",
