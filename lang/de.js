export default {
	...
	"components.pageable.info": "{count, plural, one {{AnzahlFormatiertes} Element} other {{AnzahlFormatierte} Elemente}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{AnzahlFormatiertes} of {GesamtzahlFormatiertes} Element} other {{AnzahlFormatierte} of {GesamtzahlFormatierte} Elemente}}",
