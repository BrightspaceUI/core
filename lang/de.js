export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Elemente neu anordnen; aktuelle Position: {currentPosition} von {size}. Drücken Sie zum Bewegen dieses Elements auf den Pfeil nach rechts oder den Pfeil nach links.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Element in der Liste nach rechts oder links verschieben.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Element in der Liste nach rechts oder links verschieben.",
	...
	"components.page.footer-region-label": "Fußzeile",
	...
	"components.scroll-wrapper.scroll-left": "Bildlauf links",
	"components.scroll-wrapper.scroll-right": "Bildlauf rechts",
