export default {
	...
	`{number, plural,
		...
		many {{number} resultados de búsqueda}
	...
	`{count, plural,
		...
		many {Se han encontrado {count} errores en la información que ha enviado}
