export default {
	...
	"components.backdrop-stale-overlay.message": "Estos datos no están actualizados.",
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Reordenar elementos, posición actual {currentPosition} de {size}. Para mover este elemento, pulse las teclas de flecha izquierda o derecha.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Mover el elemento hacia la izquierda o hacia la derecha en la lista.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Mover el elemento hacia la izquierda o hacia la derecha en la lista.",
	...
	"components.page.side-nav-scrim": "El contenido principal está oculto por el panel de navegación lateral. Cierre el panel para acceder.",
	...
	"components.page.supporting-scrim": "El contenido principal está oculto por el panel complementario. Cierre el panel para acceder.",
