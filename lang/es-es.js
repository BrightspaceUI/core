export default {
	...
	"components.table-col-sort-button.title": "{sourceType, select, dates {{direction, select, desc {Orden de más reciente a más antiguo} other {Orden de más antiguo a más reciente}}} numbers {{direction, select, desc {Orden de mayor a menor} other {Orden de menor a mayor}}} words {{direction, select, desc {Orden de a Z a la A} other {Orden de a A a la Z}}} value {Sorted {selectedMenuItemText}} other {{direction, select, desc {Orden descendente} other {Orden ascendente}}}}",
