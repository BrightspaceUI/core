export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Omarranger element, aktuel position {currentPosition} ud af {size}. For at flytte dette element skal du trykke på venstre eller højre pil.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Flyt element til venstre eller højre på listen.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Flyt element til venstre eller højre på listen.",
	...
	"components.page.footer-region-label": "Sidefod",
