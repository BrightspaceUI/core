export default {
	...
	`{maxExclusive, select,
		true {Tal skal være mindre end {max}.}
		other {Tal skal være mindre end eller lig med {max}.}
	}`,
	"components.form-element.input.number.rangeUnderflow":
	`{minExclusive, select,
		true {Tal skal være større end {min}.}
		other {Tal skal være større end eller lig med {min}.}
	}`,
