...
export default {
	...
	"components.filter.activeFilters": "Filtres actifsï¿½:",
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {Aucun filtre appliquï¿½.} one {{number} filtre appliquï¿½.} other {{number} filtres appliquï¿½s.}}",
	...
	"components.filter.searchResults": "{number, plural, = 0 {Aucun rï¿½sultat de recherche} one {{number} rï¿½sultat de recherche} other {{number} rï¿½sultats de recherche}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {Il y avait {count} erreur trouvï¿½e dans les informations que vous avez soumises} other {Il y avait {count} erreurs trouvï¿½es dans les informations que vous avez soumises}}",
