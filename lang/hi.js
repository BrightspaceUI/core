...
export default {
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {आपके द्वारा सबमिट की गई जानकारी में एक त्रुटि मिली थी} other {आपके द्वारा सबमिट की गई जानकारी में {count} त्रुटियाँ मिली थीं}}",
