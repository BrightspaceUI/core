...
export default {
	...
	"components.list-item-tooltip.left-right-desc": "मौजूदा आइटम में फ़ोकस को इधर से उधर ले जाएँ।",
	"components.list-item-tooltip.page-up-down-key": "पेज ऊपर/नीचे",
	"components.list-item-tooltip.page-up-down-desc": "एक बार में पाँच आइटम पर फ़ोकस ले जाएँ।",
