...
export default {
	...
	"components.filter.searchResults": "{number, plural, =0 {कोई खोज परिणाम नहीं} एक {{number} खोज परिणाम} अन्य {{number} खोज परिणाम}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {आपके द्वारा सबमिट की गई जानकारी में {count} त्रुटियाँ पाई गईं} अन्य {आपके द्वारा सबमिट की गई जानकारी में {count} त्रुटियाँ पाई गईं}}",
