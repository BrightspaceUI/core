export default {
	...
	"components.backdrop-stale-overlay.message": "यह डेटा पुराना है।",
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "आइटम का क्रम बदलें, {size} में से वर्तमान स्थिति {currentPosition} इस आइटम को ले जाने के लिए, बायाँ या दायाँ ऐरो दबाएँ।",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "आइटम को सूची में बाएँ या दाएँ ले जाएँ।",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "आइटम को सूची में बाएँ या दाएँ ले जाएँ।",
	...
	"components.page.footer-region-label": "फ़ुटर",
	...
	"components.page.side-nav-scrim": "मुख्य सामग्री अभी साइड नेविगेशन पैनल से छिपी हुई है। एक्सेस करने के लिए पैनल बंद करें।",
	"components.page.supporting-divider-label": "सपोर्टिंग पैनल डिवाइडर",
	"components.page.supporting-label": "सपोर्टिंग",
	"components.page.supporting-scrim": "मुख्य सामग्री अभी सपोर्टिंग पैनल से छिपी हुई है। एक्सेस करने के लिए पैनल बंद करें।",
