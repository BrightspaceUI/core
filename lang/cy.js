export default {
	...
	"components.input-date-time.errorMaxDateOnly2": "Date must be before or on {maxDate}",
	"components.input-date-time.errorMinDateOnly2": "Date must be on or after {minDate}",
	...
	"components.input-date.errorMaxDateOnly2": "Date must be before or on {maxDate}",
	"components.input-date.errorMinDateOnly2": "Date must be on or after {minDate}",
