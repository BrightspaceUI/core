...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {Dim hildwyr wedi'u gweithredu.} un {1 hidlydd wedi'i weithredu.} arall {{number} hidlydd wedi'u gweithredu.}}",
	"components.filter.filters": "Hidlyddion",
	"components.filter.noFilters": "Dim hidlyddion ar gael",
	"components.filter.searchResults": "{number, plural, =0 {Dim canlyniadau chwilio} un {1 canlyniad chwilio} arall {{number} canlyniad chwilio}}",
