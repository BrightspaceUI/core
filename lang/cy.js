...
export default {
	...
	"components.form-element.input.number.rangeError": "{minExclusive, select, true {{maxExclusive, select, true {Number must be greater than {min} and less than {max}.} arall {Number must be greater than {min} and less than or equal to {max}.}}} arall {{maxExclusive, select, true {Number must be greater than or equal to {min} and less than {max}.} arall {Number must be greater than or equal to {min} and less than or equal to {max}.}}}}",
	"components.form-element.input.number.rangeOverflow": "{maxExclusive, select, true {Number must be less than {max}.} arall {Number must be less than or equal to {max}.}}",
	"components.form-element.input.number.rangeUnderflow": "{minExclusive, select, true {Number must be greater than {min}.} arall {Number must be greater than or equal to {min}.}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {There was 1 error found in the information you submitted} arall {There were {count} errors found in the information you submitted}}",
