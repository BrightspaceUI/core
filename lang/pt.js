export default {
	...
	"components.pageable.info": "{count, plural, one {{countFormatted} item} outro {{countFormatted} itens}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{countFormatted} of {totalCountFormatted} item} other {{countFormatted} of {totalCountFormatted} itens}}",
