...
export default {
	...
	"components.input-date-time.time": "Tempo",
	"components.input-date.clear": "Desmarcar",
	...
	"components.tabs.next": "Rolar para Direita",
	"components.tabs.previous": "Rolar para Esquerda"
};
