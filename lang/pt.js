...
export default {
	...
	"components.form-element.input.number.rangeError": "O número deve estar entre {min} e {max}.",
	"components.form-element.input.number.rangeOverflow": "O número deve ser menor que {max}.",
	"components.form-element.input.number.rangeUnderflow": "O número deve ser maior que {min}.",
	...
	"components.input-date-time-range.to": "para",
