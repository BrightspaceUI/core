export default {
	...
	"components.filter.filterCountDescription":
		`{number, plural, =0 {لم يتم تطبيق أي عوامل تصفية.} one {تم تطبيق {number} عامل تصفية.} other {تم تطبيق {number} من عوامل التصفية.}}`,
	...
	"components.filter-dimension-set-date-text-value.textDays":
		`{num, plural, =0 {اليوم} one {آخر {num} يوم} other {آخر {num} من الأيام}}`,
	...
	"components.tag-list.role-description":
		`{count, plural, =0 {قائمة  علامات لا تضم أي عناصر} one {قائمة  علامات تضم {count} عنصرًا واحدًا} other {قائمة  علامات تضم {count} من العناصر}}`,
