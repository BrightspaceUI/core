export default {
	...
	"components.view-switcher.role-description":
		`{count, plural, =0 {مبدّل العرض يتضمن 0 عنصر} =2 {مبدّل العرض يتضمن {count} عنصرين} one {مبدّل العرض يتضمن {count} عنصر} few {مبدّل العرض يتضمن {count} عناصر} many {مبدّل العرض يتضمن {count} عنصر} other {مبدّل العرض يتضمن {count} عنصر}}`,
