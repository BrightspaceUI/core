...
export default {
	...
	"components.calendar.show": "{month} の表示",
	...
	"components.more-less.less": "より少ない",
	"components.more-less.more": "より多い",
	"components.tabs.next": "右にスクロール",
	"components.tabs.previous": "左にスクロール"
};
