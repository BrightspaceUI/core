...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {フィルタは適用されていません。} one {{number} 個のフィルタが適用されています。} other {{number} 個のフィルタが適用されています。}}",
	"components.filter.filters": "フィルタ",
	"components.filter.noActiveFilters": "アクティブフィルタなし",
	"components.filter.noFilters": "使用可能なフィルタはありません",
	"components.filter.searchResults": "{number, plural, =0 {検索結果なし} one {{number} 件の検索結果} other {{number} 件の検索結果}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {送信した情報に {count} 件のエラーが見つかりました} other {送信した情報に {count} 件のエラーが見つかりました}}",
