export default {
	...
	"components.table.words.asc": "Sorted A to Z",
	"components.table.words.desc": "Sorted Z to A",
	"components.table.numbers.asc": "Sorted low to high",
	"components.table.numbers.desc": "Sorted high to low",
	"components.table.dates.asc": "Sorted old to new",
	"components.table.dates.desc": "Sorted new to old",
	"components.table.change-sort-order": "click to change sort order",
	"components.table.add-sort-order": "click to add sort order",
