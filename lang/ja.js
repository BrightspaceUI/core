export default {
	...
	"components.pageable.info": "{count, plural, one {{countFormatted} 個の項目} other {{countFormatted} 個の項目}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{countFormatted}/{totalCountFormatted} 個の項目} other {{countFormatted}/{totalCountFormatted} 個の項目}}",
