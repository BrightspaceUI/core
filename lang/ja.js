export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "項目を並べ替えます。現在の位置は {size} 件中 {currentPosition} 件目です。この項目を移動するには、左右の矢印キーを押します。",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "リスト内の項目を左右に移動します。",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "リスト内の項目を左右に移動します。",
	...
	"components.page.footer-region-label": "フッター",
