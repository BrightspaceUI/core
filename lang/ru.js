export default {
	...
	"components.filter.filterCountDescription":
		`{number, plural, =0 {Фильтры не применены.} one {Применен {number} фильтр.} few {Применено {number} фильтра.} many {Применено {number} фильтров.} other {Применено {number} фильтра.}}`,
	...
	"components.filter.searchResults":
		`{number, plural, =0 {Нет результатов поиска} one {{number} результат поиска} few {{number} результата поиска} many {{number} результатов поиска} other {{number} результата поиска}}`,
	...
	"components.filter-dimension-set-date-text-value.textDays":
		`{num, plural, =0 {Сегодня} one {За последний {num} день} few {За последние {num} дня} many {За последние {num} дней} other {За последние {num} дня}}`,
	"components.filter-dimension-set-date-text-value.textHours":
		`{num, plural, =1 {За последний час} few {За последние {num} часа} many {За последние {num} часов} other {За последние {num} часа}}`,
	...
	"components.selection.select-all-items":
		`{count, plural, =1 {Выбрать элемент} one {Выбрать все элементы ({countFormatted})} few {Выбрать все элементы ({countFormatted})} many {Выбрать все элементы ({countFormatted})} other {Выбрать все элементы ({countFormatted})}}`,
	...
	"components.tag-list.role-description":
		`{count, plural, =0 {Список тегов с 0 элементов} one {Список тегов с {count} элементом} few {Список тегов с {count} элементами} many {Список тегов с {count} элементами} other {Список тегов с {count} элемента}}`,
	...
	"components.view-switcher.role-description":
		`{count, plural, =0 {Смотреть переключатель с 0 элементов} one {Смотреть переключатель с {count} элементом} few {Смотреть переключатель с {count} элементами} many {Смотреть переключатель с {count} элементами} other {Смотреть переключатель с {count} элемента}}`,
