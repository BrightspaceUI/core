...
export default {
	...
	"components.filter.filterCountDescription": "{number, plural, =0 {未应用筛选器。} one {已应用 {number} 个筛选器。} other {已应用 {number} 个筛选器。}}",
	"components.filter.filters": "个筛选条件",
	"components.filter.noActiveFilters": "没有活动的筛选器",
	"components.filter.noFilters": "无可用筛选器",
	"components.filter.searchResults": "{number, plural, =0 {无搜索结果} one {{number} 个搜索结果} other {{number} 个搜索结果}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {在您提交的信息中发现 {count} 个错误} other {在您提交的信息中发现 {count} 个错误}}",
