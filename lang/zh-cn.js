...
export default {
	...
	"components.form-element.input.number.rangeOverflow": "{maxExclusive, select, true {数目必须小于 {max}。} other {数目必须小于或等于 {max}。}}",
	"components.form-element.input.number.rangeUnderflow": "{minExclusive, select, true {数目必须大于 {min}。} other {数目必须大于或等于 {min}。}}",
