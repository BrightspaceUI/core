export default {
	...
	"components.pageable.info": "{count, plural, one {{countFormatted} 项} other {{countFormatted} 项}}",
	"components.pageable.info-with-total": "{totalCount, plural, one {{countFormatted}/{totalCountFormatted} 项} other {{countFormatted}/{totalCountFormatted} 项}}",
