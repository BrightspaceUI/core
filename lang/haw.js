export default {
	...
	"components.input-number.hintDecimalDuplicate": "Aia kahi decimal i loko o kēia helu nō",
	"components.input-number.hintDecimalIncorrectComma": "No ka hoʻohui ʻana i kahi decimal e hoʻohana i ke koma “,” huaʻōlelo",
	"components.input-number.hintDecimalIncorrectPeriod": "ʻInā e hoʻohui i kahi puni, e hoʻohana i ka hōʻailona piko ‘.’",
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "E hoʻonohonoho hou i ka mea, ke kūlana o kēia manawa {currentPosition} mai loko mai o {size}. No ka hoʻoneʻe ʻana i kēia mea, e kaomi i nā pua hema a ʻākau paha.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "E hoʻoneʻe i ka mea ma ka hema a i ʻole ma ka ʻākau i loko o ka papa inoa.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "E hoʻoneʻe i ka mea ma ka hema a i ʻole ma ka ʻākau i loko o ka papa inoa.",
	...
	"components.page.footer-region-label": "wāwae wāwae",
