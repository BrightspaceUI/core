export default {
	...
	"components.calendar.show": "Hōʻike {mahina}",
	"components.count-badge.plus": "{helu}+",
	...
	"components.form-element.input.number.rangeError": "{minExclusive, koho, ʻoiaʻiʻo {{maxExclusive, koho, ʻoiaʻiʻo {Pono ka nui o ka helu ma mua o {min} a emi iho ma mua o {max}.} ʻOi aku ka nui o ka helu ma mua o {min} a emi mai a like paha me {max}. }}} ʻē aʻe {{maxExclusive, koho, ʻoiaʻiʻo {Pono ka helu ma mua o ka {min} a emi iho ma mua o {max}.} ʻO ka helu ʻē aʻe {Pono ka helu ma mua a i ʻole like me {min} a emi iho a like paha {max}.}}}}",
	"components.form-element.input.number.rangeOverflow": "{maxExclusive, koho, ʻoiaʻiʻo {Pono ka helu ma mua o {max}.} ʻē aʻe {Pono ka helu ma mua a i ʻole like me {max}.}}",
	"components.form-element.input.number.rangeUnderflow": "{minExclusive, koho, ʻoiaʻiʻo {Pono ka helu ma mua o {min}.} ʻē aʻe {Pono ka helu ma mua a i ʻole like me {min}.}}",
	...
	"components.pager-load-more.action-with-page-size": "Hoʻouka {helu} hou aku",
	...
	"components.selection.action-max-hint": "{count, plural, hoʻokahi {Disabled when more than {countFormatted} item is selected} other {Disabled when more than {countFormatted} items are selected}}",
	...
	"components.selection.selected": "{helu} koho ʻia",
	"components.selection.selected-plus": "{helu}+ koho ʻia",
	...
	"components.tag-list.interactive-label": "Papa inoa inoa, {helu} mau mea",
	"components.tag-list.num-hidden": "+ {helu} hou aku",
