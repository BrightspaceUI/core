export default {
	...
	"components.backdrop-stale-overlay.message": "Ces données ne sont plus à jour.",
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Réordonner les éléments, position actuelle {currentPosition} sur {size}. Pour déplacer cet élément, appuyez sur les flèches vers la gauche ou vers la droite.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Déplacez l’élément vers la gauche ou vers la droite dans la liste.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Déplacez l’élément vers la gauche ou vers la droite dans la liste.",
	...
	"components.page.footer-region-label": "Bas de page",
	...
	"components.page.side-nav-scrim": "Le contenu principal est actuellement masqué par le panneau de navigation latéral. Fermez le panneau pour y accéder.",
	"components.page.supporting-divider-label": "Séparateur de panneau d’aide",
	"components.page.supporting-label": "Pris en charge",
	"components.page.supporting-scrim": "Le contenu principal est actuellement masqué par le panneau d’aide. Fermez le panneau pour y accéder.",
