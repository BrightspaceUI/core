...
export default {
	...
	"components.form-element.input.number.rangeError": "{minExclusive, select, true {{maxExclusive, select, true {Le chiffre doit être supérieur à {min} et inférieur à {max}.} other {Le chiffre doit être supérieur à {min} et inférieur à ou égal à {max}.}}} other {{maxExclusive, select, true {Le chiffre doit être supérieur ou égal à {min} et inférieur à {max}.} other {Le chiffre doit être supérieur ou égal à {min} et inférieur ou égal à {max}.}}}}",
	"components.form-element.input.number.rangeOverflow": "{maxExclusive, select, true {Le chiffre doit être inférieur à {max}.} other {Le chiffre doit être inférieur ou égal à {max}.}}",
	"components.form-element.input.number.rangeUnderflow": "{minExclusive, select, true {Le chiffre doit être supérieur à {min}.} other {Le chiffre doit être supérieur ou égal à {min}.}}",
	...
	"components.form-error-summary.errorSummary": "{count, plural, one {1 erreur trouvée dans les informations soumises} other {{count} erreurs trouvées dans les informations soumises}}",
