...
export default {
	...
	"components.filter.filterCount": "{number, select, max {Más de 99} all {Todos} other {{number}}}",
	"components.filter.filterCountDescription": "{number, plural, zero {Sin filtros aplicados.} one {un filtro aplicado.} other {{number} filtros aplicados.}}",
