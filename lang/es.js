export default {
	...
	"components.backdrop-stale-overlay.message": "Estos datos están desactualizados.",
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Reordenar elemento, posición actual {currentPosition} de {size}. Para mover este elemento, presione las flechas hacia la izquierda o hacia la derecha.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Mover elemento hacia la izquierda o hacia la derecha en la lista.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Mover elemento hacia la izquierda o hacia la derecha en la lista.",
	...
	"components.page.footer-region-label": "Pie de página",
	...
	"components.page.side-nav-scrim": "El panel de navegación lateral oculta actualmente el contenido principal. Cierre el panel para acceder.",
	"components.page.supporting-divider-label": "Divisor de panel de soporte",
	"components.page.supporting-label": "Soporte",
	"components.page.supporting-scrim": "El panel de soporte oculta actualmente el contenido principal. Cierre el panel para acceder.",
	...
	"components.scroll-wrapper.scroll-left": "Desplácese a la izquierda",
	"components.scroll-wrapper.scroll-right": "Desplácese a la derecha",
