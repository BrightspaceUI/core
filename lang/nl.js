...
export default {
	...
	"components.form-element.input.number.rangeError": "Getal moet tussen {min} en {max} liggen.",
	"components.form-element.input.number.rangeOverflow": "Getal moet lager zijn dan {max}.",
	"components.form-element.input.number.rangeUnderflow": "Getal moet hoger zijn dan {min}.",
	...
	"components.input-date-time-range.to": "tot",
