export default {
	...
	"components.list-item-drag-handle.side-to-side.keyboard": "Items opnieuw rangschikken, huidige positie {currentPosition} van {size}. Als u dit item wilt verplaatsen, drukt u op de pijl naar links of rechts.",
	...
	"components.list-item-drag-handle-tooltip.side-to-side.left-right-desc": "Verplaats item naar links of rechts in de lijst.",
	"components.list-item-drag-handle-tooltip.side-to-side.up-down-desc": "Verplaats item naar links of rechts in de lijst.",
	...
	"components.page.footer-region-label": "Voettekst",
	...
	"components.scroll-wrapper.scroll-left": "Naar links schuiven",
	"components.scroll-wrapper.scroll-right": "Naar rechts schuiven",
