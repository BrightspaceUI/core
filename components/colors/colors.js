if (globalThis.document !== undefined && !globalThis.document.head.querySelector('#d2l-colors')) {
	...
	const lightPalette = `
		--d2l-brandoverride-highlight: var(--d2l-color-celestine-plus-2);
		--d2l-brandoverride-primary-default: var(--d2l-color-celestine);
		--d2l-brandoverride-primary-hover: var(--d2l-color-celestine-minus-1);
		--d2l-color-border-emphasized: var(--d2l-color-galena);
		--d2l-color-border-focus: var(--d2l-brandoverride-primary-default);
		...
		--d2l-color-container-sunken: #f7f8fa;
		--d2l-color-control-emphasized-default: var(--d2l-brandoverride-primary-default);
		--d2l-color-control-emphasized-hover: var(--d2l-brandoverride-primary-hover);
		--d2l-color-control-faint-default: var(--d2l-color-regolith);
		--d2l-color-control-faint-hover: var(--d2l-color-sylvite);
		--d2l-color-control-highlighted-default: var(--d2l-brandoverride-highlight);
		...
		--d2l-color-control-status-default: var(--d2l-brandoverride-primary-default);
		...
		--d2l-color-control-translucent-hover: var(--d2l-brandoverride-primary-default);
		...
		--d2l-color-icon-status-info: var(--d2l-brandoverride-primary-default);
		...
		--d2l-color-text-interactive-default: var(--d2l-brandoverride-primary-default);
		--d2l-color-text-interactive-hover: var(--d2l-brandoverride-primary-hover);
		...
		--d2l-color-text-status-default: var(--d2l-brandoverride-primary-default);
	...
	const darkPalette = `
		...
		--d2l-brandoverride-primary-default: var(--d2l-color-celestine-plus-1);
		--d2l-brandoverride-primary-hover: var(--d2l-color-celestine);
		--d2l-color-border-emphasized: var(--d2l-color-galena);
		--d2l-color-border-focus: var(--d2l-brandoverride-primary-default);
