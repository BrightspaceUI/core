...
/**
 * A generic almost-fullscreen dialog that provides a slot for arbitrary content and a "footer" slot for workflow buttons. Apply the "data-dialog-action" attribute to workflow buttons to automatically close the dialog with the action value.
 ...
 */
class DialogExtended extends LocalizeCoreElement(AsyncContainerMixin(DialogMixin(LitElement))) {
...
customElements.define('d2l-dialog-extended', DialogExtended);
