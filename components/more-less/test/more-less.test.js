...
describe('d2l-more-less', () => {
	...
	describe('general', () => {
		...
		it('should not re-animate when re-displaying', async() => {
			const parentNode = elem.parentNode;
			const adjustToContentSpy = spy(elem, '__adjustToContent');
			...
			expect(adjustToContentSpy.called).to.be.false;

			adjustToContentSpy.restore();
		});
