...
describe('d2l-button-icon', () => {
	...
	[
		...
		{ category: 'translucent', template: html`<div style="display: inline-block; padding: 10px; line-height: 0; background: repeating-linear-gradient(45deg,	#606dbc, #606dbc 10px, #465298 10px, #465298 20px);"><d2l-button-icon icon="tier1:gear" text="Icon Button" translucent></d2l-button-icon></div>` },
		{ category: 'dark', template: html`<div style="display: inline-block; padding: 10px; line-height: 0; background: black;"><d2l-button-icon icon="tier1:gear" text="Icon Button" theme="dark"></d2l-button-icon></div>` },
