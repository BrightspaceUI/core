...
class InputText extends FormElementMixin(SkeletonMixin(RtlMixin(LitElement))) {
	...
	get validationMessage() {
		if (this.validity.rangeOverflow) {
			return this.localize('components.form-element.input.number.rangeOverflow', { max: formatNumber(parseFloat(this.max)), maxInclusive: ' or equal to' });
		} else if (this.validity.rangeUnderflow) {
			return this.localize('components.form-element.input.number.rangeUnderflow', { min: formatNumber(parseFloat(this.min)), minInclusive: ' or equal to' });
