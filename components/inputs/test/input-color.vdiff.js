...
describe('d2l-input-color', () => {
	...
	[
		...
		{ name: 'inline-help', template: html`<d2l-input-color label="Custom Color" type="custom" value="#8ad934" disabled><div slot="inline-help">Inline help</div></d2l-input-color>` },
