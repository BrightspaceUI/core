...
| Name | Description |
|---|---|
| `d2l-dropdown-before-open` | Dispatched before the dropdown is opened. A Promise may be appended to the event's `detail.ready` array enabling updates before opening. |
