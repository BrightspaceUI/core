...
describe('d2l-link', () => {
	...
	[
		...
		{ name: 'wc-standard-new-window-overflow', template: html`<div style="width: 235px"><d2l-link new-window href="https://www.d2l.com">Standard New Window Link</d2l-link></div>` },
