...
describe('d2l-link', () => {
	...
	[
		...
		{ name: 'wc-standard-new-window-truncated-flex', template: html`<div style="width: 240px; display: flex;"><d2l-link lines="2" target="_blank" href="https://www.d2l.com">Standard New Window Link That is Much Longer Than the Container</d2l-link></div>` },
		{ name: 'wc-standard-new-window-truncated-one-flex', template: html`<div style="width: 240px; display: flex;"><d2l-link lines="1" target="_blank" href="https://www.d2l.com">Standard New Window Link That is Much Longer Than the Container</d2l-link></div>` },
		...
		{ name: 'wc-disabled-tooltip', template: html`<d2l-link href="https://www.d2l.com" disabled disabled-tooltip="This link is disabled">Disabled Link with Tooltip</d2l-link>` },
