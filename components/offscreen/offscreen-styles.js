...
export const _offscreenStyleDeclarations = css`
	...
	height: ${HAS_DOCUMENT && OffSCREEN_SIZELESS ? 0 : 1}px; // The HAS_DOCUMENT check can be removed once the d2l-offscreen-sizeless flag is removed and set to 1px
	inset-inline-start: -10000px;
	overflow: hidden;
	position: absolute !important;
	white-space: nowrap;
	width: ${HAS_DOCUMENT && OffSCREEN_SIZELESS ? 0 : 1}px; // The HAS_DOCUMENT check can be removed once the d2l-offscreen-sizeless flag is removed and set to 1px
`;
