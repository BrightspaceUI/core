...
describe('d2l-collapsible-panel', () => {
	...
	describe('ltr', () => {
		...
		[
			...
			{ name: 'summary-item-text-wrapping', selector: '#summary-item-text-wrapping' },
			{ name: 'summary-item-text-lines', selector: '#summary-item-text-lines' },
			{ name: 'summary-item-text-lines-unbreakable', selector: '#summary-item-text-lines-unbreakable' },
