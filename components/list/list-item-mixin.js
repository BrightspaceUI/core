...
export const ListItemMixin = superclass => class extends composeMixins(
	...
	static get styles() {
		...
		const styles = [ css`
			...
			:host([selected]:not([selection-disabled]):not([skeleton-active])) [slot="control-container"]::before,
			:host([selected]:not([selection-disabled]):not([skeleton-active])) [slot="control-container"]::after,
			...
			:host(:not([selection-disabled]):not([skeleton-active])[selected][_hovering-selection]) [slot="outside-control-container"],
			:host(:not([selection-disabled]):not([skeleton-active])[selectable][_focusing]) [slot="outside-control-container"] {
			...
			:host(:not([selection-disabled]):not([skeleton-active])[selected]) [slot="outside-control-container"] {
				background-color: #f3fbff;
				border-color: #b6cbe8; /* celestine alpha 0.3 */
				margin-bottom: -1px;
			}

			:host(:not([selection-disabled]):not([skeleton-active])[padding-type="none"]) [slot="outside-control-container"] {
			...
			:host(:not([selection-disabled]):not([skeleton-active])[_focusing][_highlighting]) [slot="outside-control-container"],
			:host(:not([selection-disabled]):not([skeleton-active])[selected][_highlighting]) [slot="outside-control-container"] {
