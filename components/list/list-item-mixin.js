...
export const ListItemMixin = superclass => class extends composeMixins(
	...
	static get styles() {
		...
		const styles = [ css`
			...
			:host([selectable][_hovering]:not([disabled]):not([selection-disabled])) [slot="control-container"]::before,
			:host([selectable][_hovering]:not([disabled]):not([selection-disabled])) [slot="control-container"]::after,
			...
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[selected]) [slot="outside-control-container"],
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[selectable][_hovering]) [slot="outside-control-container"],
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[selectable][_focusing]) [slot="outside-control-container"] {
			...
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[padding-type="none"]) [slot="outside-control-container"] {
			...
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[_hovering][_highlighting]) [slot="outside-control-container"],
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[_focusing][_highlighting]) [slot="outside-control-container"],
			:host(:not([disabled]):not([selection-disabled]):not([skeleton])[selected][_highlighting]) [slot="outside-control-container"] {
