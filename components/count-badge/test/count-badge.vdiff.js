...
describe('count-badge', () => {
	[
		...
		{ name: 'small-notification-dark', colorMode: 'dark', template: html`<d2l-count-badge size="small" type="notification" number="1"></d2l-count-badge>` },
		...
		{ name: 'small-notification-focused-dark', colorMode: 'dark', template: html`<d2l-count-badge tab-stop size="small" type="notification" number="1"></d2l-count-badge>`, action: elem => focusElem(elem) },
		...
		{ name: 'large-count-colorway-override-dark', colorMode: 'dark', template: html`<d2l-count-badge style="--d2l-count-badge-foreground-color: #ffffff; --d2l-count-badge-background-color: purple;" size="large" type="count" number="10"></d2l-count-badge>` },
		...
		{ name: 'small-count-dark', colorMode: 'dark', template: html`<d2l-count-badge size="small" type="count" number="42"></d2l-count-badge>` },
	...
	].forEach(({ name, template, colorMode, rtl, action }) => {
		it(name, async() => {
