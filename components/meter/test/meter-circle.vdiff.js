...
describe('meter-circle', () => {
	...
	[
		...
		` },
		{ name: 'rounding-ceil', template: html`<d2l-meter-circle value="1" max="3" percent percent-rounding-mode="ceil"></d2l-meter-circle>` },
		{ name: 'rounding-floor', template: html`<d2l-meter-circle value="2" max="3" percent percent-rounding-mode="floor"></d2l-meter-circle>` }
