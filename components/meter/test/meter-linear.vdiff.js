...
describe('meter-linear', () => {
	...
	[true, false].forEach(rtl => {
		[
			...
			{ name: 'normal-text-percent-ceil', template: html`<d2l-meter-linear value="1" max="3" text="Visited: {%}" percent-rounding="ceil"></d2l-meter-linear>` },
			{ name: 'normal-text-percent-floor', template: html`<d2l-meter-linear value="2" max="3" text="Visited: {%}" percent-rounding="floor"></d2l-meter-linear>` },
