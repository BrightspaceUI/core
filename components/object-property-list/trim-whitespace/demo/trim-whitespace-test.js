...
class FooTester extends LitElement {
	...
	render() {
		return html`
			<d2l-object-property-list>
				<d2l-object-property-list-item text="${this.foo}"></d2l-object-property-list-item>
				${this.bar ? html`<d2l-object-property-list-item text="item 2"></d2l-object-property-list-item>` : null}
			</d2l-object-property-list>
		`;
	}
}
...
customElements.define('foo-tester', FooTester);
