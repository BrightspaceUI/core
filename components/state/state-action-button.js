...
/**
 * `d2l-state-action-button` is an state action component that can be placed inside of the default slot of `state-simple` or `state-illustrated` to add a button action to the component.
