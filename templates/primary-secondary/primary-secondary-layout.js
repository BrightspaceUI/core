...
/**
 * A two panel (primary and secondary) layout with a resizable divider
 * @slot primary - Main content
 * @slot secondary - Supplementary content
 ...
 */
class TemplatePrimarySecondaryLayout extends LocalizeCoreElement(LitElement) {
	...
	static get styles() {
		return css`
			...
			::slotted(d2l-form-error-summary) {
...
customElements.define('d2l-template-primary-secondary-layout', TemplatePrimarySecondaryLayout);
